...
$page_nav["cadastro"]["sub"]["tipo dependente"]["active"] = true;
                                                    ...
                                                    <fieldset>
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <section class="col col-3 col-auto">
                                                                ...
                                                                <label class="input">
                                                                    <input id="tipoDependente" maxlength="100" name="tipoDependente" class="required" value="" autocomplete="off">
                                                                </label>
                                                            </section>
...
<script src="<?php echo ASSETS_URL; ?>/js/business_tipoDependente.js" type="text/javascript"></script>
...
<script language="JavaScript" type="text/javascript">
                ...
                recuperaTipoDependente(idd,
                    function(data) {
                        if (data.indexOf('failed') > -1) {
                            ...
                            var codigo = +piece[0];
                            var tipoDependente = piece[1];
                            var ativo = +piece[2];
                            //Associa as varíaveis recuperadas pelo javascript com seus respectivos campos html.
                            $("#codigo").val(codigo);
                            $("#tipoDependente").val(tipoDependente);
                            $("#ativo").val(ativo);
                            $("#verificaRecuperacao").val();
                            return;
    ...
    function novo() {
        $(location).attr('href', 'cadastroTipoDependente.php');
    }
    ...
    function validaTipoDependenteExistente() {
        var tipoDependente = $("#tipoDependente").val();

        validarTipoDependenteExistente(tipoDependente,
            function(data) {
                if (data.indexOf('failed') > -1) {
                    var piece = data.split("#");
                    var mensagem = piece[1];
                    ...
                    if (mensagem !== "") {
                        ...
                        smartAlert("Atenção", "Descrição já cadastrada no sistema!", "error");
                        $('#tipoDependente').val("");
    ...
    function gravar() {
        ...
        gravaTipoDependente(id, tipoDependente, ativo,
            function(data) {
