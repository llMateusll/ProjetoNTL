function gravaFuncionario(id, ativo, nome, cpf, dataNascimento, rg, sexo, estadoCivil, cep,logradouro,numero,complemento,uf,bairro,cidade,primeiroEmprego,pispasep,jsonTelefoneArray, jsonEmailArray, callback) {
    $.ajax({
        ...
        logradouro: logradouro, numero: numero, complemento: complemento, uf: uf, bairro: bairro, cidade: cidade, primeiroEmprego: primeiroEmprego, pispasep: pispasep, jsonTelefoneArray: jsonTelefoneArray, jsonEmailArray: jsonEmailArray },
